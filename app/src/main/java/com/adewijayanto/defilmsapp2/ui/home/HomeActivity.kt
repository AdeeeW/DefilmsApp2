...
import com.adewijayanto.defilmsapp2.databinding.ActivityHomeBinding
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navHostFragment: Fragment = supportFragmentManager.findFragmentById(R.id.nav_container) as NavHostFragment
